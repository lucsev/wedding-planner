...
const translations = {
  en: {
    translation: {
      ...
      travelSectionDescription: "<p align=\"left\">The wedding will be in <strong>Spain</strong>. You need to arrange your transportation and accommodation.</p> \
                                 <h4 align=\"left\" style=\"padding-top:10px;\">Flights</h4>\
                                 <p align=\"left\">The closest airport is Seville (SVQ). There are regular non-stop flights from Stansted (Ryanair), Luton (Ryanair) and Heathrow (BA/Iberia, EasyJet, Vueling). In <a href=\"https://www.google.com/travel/flights\">Google Flights</a> you can browse or book your flights.</p> \
                                 <h4 align=\"left\" style=\"padding-top:10px;\">Venue Directions</h4>\
                                 <p align=\"left\">The venue is the <a href=\"https://www.marriott.co.uk/hotels/travel/svqlc-hotel-alfonso-xiii-a-luxury-collection-hotel-seville/\">Hotel Alfonso XIII</a>, located at <a href=\"https://goo.gl/maps/kc6Tq7DTJTzWtuem7\">\"Calle San Fernando, 2\"</a>. If you are staying in the city centre, you should be able to get to the venue on foot or by taxi.</p>\
                                 <h4 align=\"left\" style=\"padding-top:10px;\">Choosing accommodation</h4>\
                                 <p align=\"left\">We would recommend that you stay at one of the many hotels and apartments available within 5-10 minutes' walking distance of the venue. You can book them either on <a href=\"https://www.booking.com\">Booking.com</a> or <a href=\"https://www.airbnb.com\">airbnb.com</a> . You can also stay at the <a href=\"https://www.marriott.co.uk/hotels/travel/svqlc-hotel-alfonso-xiii-a-luxury-collection-hotel-seville/\">wedding venue</a> itself, which is a five-star hotel, but rooms are £300-400 per night!</p>\
      ...
      <p align=\"left\"><span>&#8226;</span>At the Reception, we will have various nibbles.<br/><span>&#8226;</span>At the Banquet, the menu will consist of:<br/><div style=\"margin-left: 20px; text-align: left;\">   -Starter: TBD<br/>   -Main: TBD<br/>   -Dessert: TBD<br/>   If you have any allergies or can't eat any of the ingredients (nuts, gluten, meat, fish, pork, dairy), please let us know and we will try to accommodate your request.</div><span>&#8226;</span>A couple of hours after the Banquet, there will be an additional round of nibbles.</p> \
      <h4 align=\"left\" style=\"padding-top:10px;\">Etiquette</h4>\
      <p align=\"left\">The dress code for our wedding is <a href=\"https://www.brides.com/semi-formal-wedding-attire-4800687\">semi-formal/cocktail attire</a>. Most ladies will wear dresses, and gentlemen a suit or just a blazer, with or without tie.</p> \
      ...
      travelFAQ: [
        ...
        {title: "What flights are available?", detail: ""},
        ...
        {title: "What travel documents do I need?", detail: "<span>&#8226;</span>From November 2023, non-EU nationals will need to get an <strong><a href=\"https://www.spainvisa.eu/visa-types/etias/\">ETIAS permit</a></strong> before travelling to Spain. The process is done online, takes around 5 minutes and costs €7 per person. The permit is valid for 3 years and multiple trips to Spain and EU countries of up to 90 days per 180-day period. <br/><span>&#8226;</span>The <strong>passport<strong/> being used for the ETIAS permit needs to be valid for a minimum of 3 months from the day of entry to Spain. <br/><span>&#8226;</span>NHS COVID Vaccination QR code, or a fit-to-fly covid test as per Spanish requirements.<br/><br/>You are required to take all three documents with you when you fly to Spain (on paper or digitally)."},
      ],
      onTheDayFAQ: [
        {title: "Is there a stag do?", detail: "Yes, we will do one stag do in the UK and one in Spain. Both the grooms will attend them. Details TBD"},
      ],
      statsTitle: "Stats",
