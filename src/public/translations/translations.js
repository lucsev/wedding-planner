  ...
  en: {
    translation: {
      ...
      travelSectionDescription: "<p align=\"left\"><strong>The wedding will be in Spain. It's important that you arrange your transportation and accommodation as soon as possible to avoid prices going up.</strong></p> \
                                 ...
                                 <p align=\"left\">The closest airport is Seville (SVQ). There are regular non-stop flights from Stansted (Ryanair), Luton (Ryanair) and Gatwick (BA/Iberia, EasyJet, Vueling). You can browse or book your flights on <a href=\"https://www.google.com/travel/flights\">Google Flights</a>. <strong>As the dates are far away, some of the flights have not been released yet.</strong> The only routes that are currently released are from Stansted (Ryanair) and from Gatwick (BA only). Currently prices from Gatwick are ok, but expensive from Stansted. It's your choice if you want to book your flights now, but if you are flying from Stansted, we would advise to wait a bit longer until more routes are released and see if prices come down. We will update the website when more flights are released.</p> \
                                 ...
                                 <br />You can book them directly through their websites, on <a href=\"https://www.booking.com\">Booking.com</a> or <a href=\"https://www.airbnb.com\">airbnb.com</a> . </p>\
